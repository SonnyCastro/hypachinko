...
export function ActionButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
    >
      <div className='flex flex-row gap-2.5 items-center justify-center px-4 py-3'>
        {icon && (
          <div className='w-6 h-6 relative'>
            <img src={icon} alt={text} className='w-full h-full' />
          </div>
        )}
        <div className='text-bagel font-normal text-3xl text-[var(--color-figma-dark-600)] text-center leading-8'>
          {text}
        </div>
      </div>
    </button>
